		...
		<div className="w-full h-auto pb-10 bg-neutral-900 mt-10" id="#experience">
			<div className="pb-10 w-full px-5 lg:px-16 pt-5 ">
				...
				<div className="grid grid-cols-1 md:grid-cols-2 place-items-center gap-3">
					...
					{/* third */}
					<div
						className="h-auto flex flex-row justify-evenly mt-10"
						data-aos="fade-left"
						data-aos-delay="50"
						data-aos-duration="1000"
						data-aos-easing="ease-in-out"
						...
						<div className="left w-full ml-2">
							...
							<div className="second ml-6" style={{ fontFamily: "Poppins" }}>
								<li className="text-gray-200 ml-5 text-wrap leading-relaxed tracking-wide text-sm mt-5">
									I worked on a full-stack web application inspired by Facebook
									Marketplace, allowing users to browse, post, and manage
									listings for items for sale.{" "}
								</li>
								<li className="text-gray-200 ml-5 text-wrap leading-relaxed tracking-wide text-sm mt-5">
									{" "}
									Built with  {""}
									...
									for the front-end, implementing smooth state management using{" "}
									<span className="header">Zustand</span> and{" "}
									<span className="header">Tailwind CSS </span>
									for styling {""}
									 <span className="header">Cursor AI </span>
									for debugging and speeding up development process
								</li>
							</div>
						</div>
					</div>
